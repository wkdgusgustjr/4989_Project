...
<html>
	<head>
		...
		<!-- memberfeed 스타일시트 -->
		<link rel="stylesheet" type="text/css" href="/resources/css/css_memberfeed.css?var=<%=System.currentTimeMillis()%>">
			...
			<table>
				<tr>
					<th style="width: 30%; height: 200px;">
						<!-- 프로필사진 -->
						<img style="pointer-events: none;" id="profileImg" src="/resources/profileimages/${ friendProfile.profile_image }">
					</th>
