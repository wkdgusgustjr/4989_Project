...
@WebServlet("/qnaboard_info.do")
public class QnABoard_Info_Action extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher disp = request.getRequestDispatcher("board/qnaboard_info.jsp");
